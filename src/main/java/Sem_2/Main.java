...
public class Main {
    public static void main(String[] args) {
        Zoo zoopark = new Zoo();
        zoopark.addAnimals(List.of(new Cat("Barsik"), new Dog("Sharik"), new Rabbit("Whik"), new Cow("Murka"), new Duck("Krya"), new Butterfly("Yellow"), new Shark("Killer"), new GoldFish("Perry")));
        ...
        System.out.println("---------------------------------------------");
        for (SwimmingSpeed item : zoopark.getSwimmingSpeed()){
            System.out.println(item);
        }
        System.out.println("---------------------------------------------");
